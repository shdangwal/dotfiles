import{c,i as p,o as d}from"./chunk-BHCSV6LT.js";import"./chunk-EK7ODJWE.js";var r=class{constructor(){}json(...t){let n=t[0].tabs.map(({title:a,url:e,favIconUrl:o})=>({title:a,url:e,favIconUrl:o}));return JSON.stringify(n)}csv(...t){let n=`url,title,favIconUrl
