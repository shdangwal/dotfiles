!(function (N, A) {
	...
	return (function (N) {
		...
		return (
			...
			(A.d = function (N, t, I) {
				A.o(N, t) || Object.defineProperty(N, t, { configurable: !1, enumerable: !0, get: I });
			}),
			(A.n = function (N) {
				var t =
					N && N.__esModule
		...
		function (N, A, t) {
			...
			(A = N.exports =
				function (N) {
					(N.EXCEPTIONS = { 嗲: "DIA", 碡: "ZHOU", 聒: "GUO", 炔: "QUE", 蚵: "KE", 砉: "HUA", 嬷: "MO", 蹊: "XI", 丬: "PAN", 霰: "XIAN", 豉: "CHI", 饧: "XING", 帧: "ZHEN", 芎: "XIONG", 谁: "SHUI", 钶: "KE" }),
					(N.UNIHANS[91] = "伕"),
					(N.UNIHANS[347] = "仚"),
					(N.UNIHANS[393] = "诌"),
					(N.UNIHANS[39] = "婤"),
		...
		function (N, A, t) {
			...
			N.exports = { PINYINS: U, UNIHANS: I, EXCEPTIONS: e };
		},
		function (N, A, t) {
			"use strict";
			var I = t(0),
