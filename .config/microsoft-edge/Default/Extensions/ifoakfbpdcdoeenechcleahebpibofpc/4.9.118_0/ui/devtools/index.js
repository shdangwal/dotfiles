(function () {
    ...
    function Body(props) {
        ...
        const previewNewestButtonText = data.settings.previewNewestDesign
            ? "Switch to old design"
            : "Preview new design";
        ...
        function toggleNewestDesign() {
            actions.changeSettings({
                previewNewestDesign: !data.settings.previewNewestDesign,
            ...
            m$1(
                ...
                m$1(
                    ...
                    m$1(
                        "div",
                        {class: "buttons"},
                        isMobile || !data.settings.previewNewDesign
                            ? null
                            : m$1(
                                  Button,
                                  {
                        ...
                        m$1(
                            ...
                            {
                                class: "preview-design-button",
                                onclick: toggleNewestDesign
                            },
                            previewNewestButtonText
                        )
                    )
                )
            ),
